...
.. important::
   ...
   **not be valid if your [cloud-7042] container is NOT running**.

.. tip::
   You must have your [cloud-7042] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=42615  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='hardikdagar7'  \-\-env DOCKERUSERNAME='hardikdagar0207'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   hardikdagar0207/cloud-7042-amd64 (https://hub.docker.com/r/hardikdagar0207/cloud-7042-amd64)
...
.. code-block::
   ...
   docker run -d -p 36775:36775 -p 51637:51637 -p 33743:33743 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=cloud-7042 \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cloud-7042 \
          --env GITUSERNAME=hardikdagar7 \
          --env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git \
          --env SOLUTIONEXTERNALPORT=36775 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=51637  \
          --env SOLUTIONVIPERVIZPORT=33743 \
          ...
          hardikdagar0207/cloud-7042-amd64
...
[cloud-7042] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/hardikdagar7/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cloud-7042
...
.. important::
   https://cloud-7042.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cloud-7042
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=36775, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37141, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=40181, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40083, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=40631, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33689, HPDEHOST=127.0.1.1, HPDEPORT=38779, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44151

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-54-cloud-7042,solution_preprocessing_ai_mqtt_dag-cloud-7042, python-preprocess-3523-cloud-7042,solution_preprocessing_ai_mqtt_dag-cloud-7042, python-ai-6219-cloud-7042,solution_preprocessing_ai_mqtt_dag-cloud-7042, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
